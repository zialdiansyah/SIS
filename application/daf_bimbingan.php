		...
		<div id="main">				
				<table border="1">
					...
					<tr>
						...
						<td><a href="daf_bimbingan_upt.php?id=<?php echo("$data1[id_p_s_prasidang]"); ?>">update</a> || <a href="daf_bimbingan_log.php?id=<?php echo("$data1[id_p_s_prasidang]"); ?>">log</a> || <a href="daf_bimbingan_dtl.php?id=<?php echo("$data1[id_p_proposal]"); ?>">detail</a></td>
					</tr>
					<?php }	?>
				</table>
				<br />
