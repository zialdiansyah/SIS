...
<div id="wrap">
	...
	<div id="content-wrap">
		...
		<div id="main">				
			<h2>daftar mahasiswa yg mengikuti prasidang</h2> <br />
			<table border="1">
				<tr>
					<th>no.</th>
					<th>nim</th>
				...
				<tr>
					...
					<td><a href="komen_prasidang.php?id=<?php echo("$data1[id_p_s_prasidang]"); ?>">[komentar]</a></td>
				</tr>
				<?php } ?>
			</table>
