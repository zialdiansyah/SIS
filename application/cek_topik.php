<?php
	...
	$sql1 = "
	select 
	m.nim, m.nama, pt.judul, pt.id_p_topik, pt.abstrak, pt.status, pt.komen
	from
			...
			<fieldset>
				<table border="1">
					...
					<tr>
						...
						<td><a href="cek_topik_tbh.php?id=<?php echo("$data1[id_p_topik]"); ?>">komentar</a></td>
					</tr>
					<?php } ?>
				</table>
			</fieldset>
